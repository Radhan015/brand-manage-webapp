...
class RequestController extends Controller
{
    public function store(Request $request)
    {
        $request->validate([
            ...
            'project_type' => 'required|in:Graphic Design,Video,Photography,Lainnya',
            ...
            'drive_url' => ['required', 'string', 'url', 'regex:/drive\.google\.com/i'],
        ], [
            'event_start_date.after_or_equal' => 'Maaf, request tidak bisa dadakan. Tanggal (tenggat) minimal adalah H-3 (3 hari dari sekarang).',
            'drive_url.regex' => 'Link harus berupa tautan Google Drive yang valid (mengandung drive.google.com).',
            'drive_url.url' => 'Format link tidak valid.',
        ]);
